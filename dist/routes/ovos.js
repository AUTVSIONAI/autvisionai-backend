...
export default async function ovosRoutes(fastify) {
    ...
    fastify.post('/speak', async (request, reply) => {
        try {
            ...
            const ovosResponse = await axios.post(`${OVOS_API_URL}/api/v1/tts/speak`, payload, {
                headers: {
    ...
    fastify.post('/listen', async (request, reply) => {
        try {
            ...
            const ovosResponse = await axios.post(`${OVOS_API_URL}/api/v1/stt/listen`, payload, {
                headers: {
                    'Content-Type': 'application/json'
                },
